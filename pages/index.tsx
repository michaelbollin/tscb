...
export default function Index({ initialPosts, allTags, preview, initialTag = '' }) {
  ...
  return (
    <Layout preview={preview} onReset={resetAll}>
      ...
      <Container>
        <h1 className="text-4xl md:text-6xl lg:text-8xl mb-10 font-playfair font-normal bg-gradient-to-r from-gray-200 to-black text-transparent bg-clip-text text-center md:text-left">
          Dishes to adore
        </h1>
